    ...
    for csv_file in csv_files:
        ...
        for column_name in column_names:
            ...
            for page_number in range(10, len(pdf.pages)):
                ...
                cropped_page = page.crop((72, 86.4, page.width - 72, page.height - 70.0))
            ...
            for column_name in column_names:
                if column_name in column_definitions:
                    ...
                    if "AMT" in column_name:
                        ...
                        column_list.append(f"replace(replace({column_name}, '$', ''), ',', '')::{data_type}")
                    else:
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python generate_syh_dr_sql_models.py <csv_folder> <data_dictionary_url>")
        sys.exit(1)
