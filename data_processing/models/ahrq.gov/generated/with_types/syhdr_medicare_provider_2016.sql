...
FROM read_csv('~/data/syh_dr/syhdr_medicare_provider_2016.CSV', header=True, null_padding=true, types={ 'Facility_ID': 'VARCHAR', 'Prvdr_Ctgry_Cd': 'VARCHAR', 'Prvdr_Ownrshp_Cd': 'VARCHAR', 'Prvdr_Prtcptn_Cd': 'VARCHAR' }, ignore_errors=true)